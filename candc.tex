...
What hardware primitives are required for scalable locking\footnote{Material for this slide is due Lorenzo Alvisi's Fall 2004 CS803 ``Distributed Computing'' slides at UT-Austin.}?
\vfill
\begin{itemize}
