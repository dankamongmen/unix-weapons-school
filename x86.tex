...
\begin{block}{80386 (Intel, AMD, Cyrix, TI, IBM, Chips, \ldots)}
\begin{itemize}
\item IBM PS/2. 32-bit segments, regs, buses
\item NatSemi 16550A UART. 80386SL: first (external) cache
\end{itemize}
\end{block}
\begin{block}{80486 (Intel, \ldots)}
\end{block}
\vfill
\begin{center}
\begin{tikzpicture}
...
\begin{tabular}{|l|r|r|c|r|}
\hline
80386-DX & 1985 & 275K@$\frac{1.5\mu\text{m CHMOS-III}}{1\mu\text{m CHMOS-IV}}$ & 32 / 32 / 32 & 12--33MHz \\
\hline
80386-SX & 1988 & 29K@3.2$\mu$m CHMOS-IV & 32 / 16 / 24 & 16--33MHz \\
\hline
