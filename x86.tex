...
\title{\textbf{x86: The Past and Glorious Present}}
\date{}
...
\begin{tabular}{|l|r|r|c|r|}
\hline
Athlon T-Bird & 2000 & 37M@180nm & fixme & fixme \\
\hline
Intel Northwood & 2003 & 55M@130nm & 20 & 1.6--3.4GHz / 400--800MHz \\
\hline
Athlon Barton & 2003 & 54M@130nm & 10/15 & 1833--2333MHz / 166--200MHz \\
\hline
Intel Prescott & 2004 & 125M@90nm & 31 & 3--3.8GHz / 533--800MHz \\
\hline
\end{tabular}%
}
};
...
\begin{itemize}
\item x86-64 instructions can be up to 15 bytes
\item Up to four prefixes per instruction:
\end{itemize}
\huge\textbf{FIXME}
\end{frame}
