...
\begin{tabular}{|l|l|l|}
\hline
MOVNT*Q/MOVNTPS & \_mm\_stream\_* & Streaming store to mem\\
\hline
...
\hline
MASKMOVD* & & Bytemasked store to mem\\
\hline
SFENCE & void\_mm\_sfence & Order point for stores\\
\hline
LFENCE & void\_mm\_lfence & Order point for loads\\
\hline
MFENCE & void\_mm\_mfence & Order point for stores and loads\footnote{\tiny{Not equivalent to SFENCE+LFENCE, which would be mutually unordered!}}\\
\hline
WBINVD & & Write back, and invalidate cache\\
\hline
INVD & & Screw it, just invalidate the caches\\
\hline
...
\hline
MWAIT (SSE3) & & Monitor a cache line\\
\hline
\end{tabular}%
}
};
