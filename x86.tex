...
\begin{frame}{On-die instruction store}
...
\vfill
\begin{itemize}
\item Latencies above are best cases (no eviction, etc.)
\item MESI details are stored in L1/l2, directory details in the LLC
(hence the latter's inclusivity)
\end{itemize}
\end{frame}
