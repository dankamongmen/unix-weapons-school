...
\begin{block}{Intel Nehalem / Westmere}
\begin{itemize}
\item Nehalem adds SSE4.2
\item Quick Path Interconnect on Nehalem-E
\end{itemize}
\end{block}
\begin{block}{Intel Sandy Bridge / Ivy Bridge}
\begin{itemize}
\item Integrated GPU, trigate FinFET
\item Ivy Bridge adds AVX, PCIe 3.0
\end{itemize}
\end{block}
\begin{block}{Intel Haswell}
\begin{itemize}
\item Transactional memory, AVX2, FMA3
\end{itemize}
\end{block}
\vfill
\begin{center}
