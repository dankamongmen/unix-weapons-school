...
\end{itemize}
\vfill\hfill\tiny{Source: \textit{Intel 64 and IA32 Architectures Optimization Manual}}
\end{frame}

\begin{frame}{On-die data store}
The latencies below are best cases (no eviction, etc.). MESI details are stored
