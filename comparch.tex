...
\scriptsize{Given inverters, we can build (\textit{functionally complete}) NORs and NANDs.}
\end{figure}
\begin{figure}
\centering{
...
\vspace{.1in}
\scriptsize{Given NORs and NANDs, we can build universal computers.}
\end{figure}

%\hfill \includegraphics[width=0.25\textwidth]{images/vtf.png}\\
%\hfill \tiny{Inverter voltage transfer function}
...
\small{\ldots and now we're getting somewhere.}
\end{figure}
\end{frame}
