...
operation, or the complicated decoding necessary to convert x86 instructions
into $\upmu$ops.
\vfill
...
\vfill
The techniques by which the pipeline is kept full are collectively known as
