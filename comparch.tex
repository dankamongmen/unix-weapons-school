...
{\tiny
\begin{tabular}{|>{\raggedleft}p{2in}|r|p{1.25in}|}
\hline
\textbf{Incident} & \textbf{Penalty} & \textbf{Ameliorations} \\
\hline\hline
Instructions having less than full throughput & Handful of \textbf{c} &
Strength reduction \\
\hline
L1 cache hit & Very few \textbf{c}, if any & Multiport/pipelined L1 \\
\hline
...
\hline
Branch misprediction / pipeline flush & \textasciitilde Pipeline length & Branch prediction, $\mu$caches, predication \\
\hline
L1 cache miss & L2 time (<10\textbf{c}) & Faster L2, bigger L1, non-temporal L/S \\
\hline
Procedure call & Dozens of \textbf{c} & Register windows, inlining \\
\hline
System call & Hundreds of \textbf{c} & Call gates \\
\hline
Bus lock (atomics, UC accesses\footnote{Including pagewalks of uncacheable tables.}) & & \\
\hline
L2 cache miss & & \\
\hline
Thread switch & & \\
